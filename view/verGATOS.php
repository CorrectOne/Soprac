      ...
      if ($result && mysqli_num_rows($result) > 0) {
        while ($linha = mysqli_fetch_assoc($result)) {
          ...
          echo "<td class='actions'>
              <a href='atualizarAnimal.php?id=$idAnimal' class='edit'>
                <i class='far fa-edit'></i>
              </a>
              <a href='../controller/cadAnimal.php?idAnimal=$idAnimal&tipo=gato' class='delete' onclick=\"return confirm('Deseja realmente excluir este gato?');\">
        ...
        echo "<tr><td colspan='8'>Nenhum gato encontrado ou erro na consulta.</td></tr>";
      }
      ?>
    </tbody>
  </table>
...
const rows = document.querySelectorAll("#gatosTable tbody tr");
